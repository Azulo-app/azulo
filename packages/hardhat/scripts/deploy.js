...
const main = async () => {
  ...
  */
  ...
  // reference: https://github.com/austintgriffith/azulo/blob/using-libraries-example/packages/hardhat/scripts/deploy.js#L19
  const yourContract = await deploy("YourContract", [], {}, {
  ...
  */
  ...
  //If you want to verify your contract on tenderly.co (see setup details in the azulo README!)
  /*
